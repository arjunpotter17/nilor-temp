...
export default function Home() {
  ...
  return (
    <div className="flex flex-col w-full gap-y-[200px]">
      ...
      <div className="flex flex-col bg-nilor-secondary gap-y-32">
        <Clients />
        <TabSwitch tabIndication={false} tabButtonColor="nilor-black" containerClassNames="!bg-transparent" title="Innovative tools. Exceptional content. Unmatched expertise.
" para="All-encompassing software. Fundamental hardware. Complete support and learning services. A fully integrated ecosystem for seamlessly delivering complex graphics in real-time to any surface." tabs={tabs}/>
      </div>
