...
export default function Clients() {
  return (
    <div className="w-full flex flex-col items-center ~gap-y-5/8 bg-nilor-accent py-10">
     ...
     <p className="w-full text-center ~px-4/0 text-xs md:nilor-pre font-nilor-semibold text-nilor-white max-w-[1152px]">Our team has decades of experience working with and for a wide range of clients at the top of their industries;<br/> <span className="text-nilor-black font-nilor-bold">nilor</span> brings all that invaluable expertise together.
     </p>
