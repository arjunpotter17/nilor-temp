...
export default function ImmersiveExp({pre, title, para, buttonText, imgSrc}:ExpDataType) {
  return (
    <div className="bg-nilor-accent w-full px-4 md:px-0 py-32 flex justify-center items-center">
      <div className="w-full flex flex-col lg:flex-row lg:justify-between lg:items-center max-w-[1152px]">
        ...
        <div className="w-full lg:max-w-[40%] h-[500px] relative perspective-800">
          <div className="w-full h-full relative transform rotate-y-[-20deg]">
            <Image
              fill
              src={imgSrc}
