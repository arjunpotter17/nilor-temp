export default function Film() {
  ...
  return (
    <div className="w-full min-h-[calc(100vh-100px)] flex flex-col justify-center items-center text-nilor-white gap-y-10">
      ...
      <p className="text-landing-section-pre">NILOR IN ACTION</p>
      <h1 className="text-landing-section-title">Next Level Visual Experiences</h1>
      <div
      ...
      >
        <div className="flex flex-col text-nilor-white w-full h-full max-w-[1152px] gap-y-10">
          <p className="text-landing-section-title">
            A Paragon Tool
          </p>
          <p className="text-landing-section-text max-w-[60%] font-nilor-semibold">
